...
const TRIGGERS = [
  ...
  { value: 'woocommerce.order_created', label: 'WooCommerce Order', icon: Zap, description: 'When an order is placed in WooCommerce' },
  { value: 'woocommerce.order_updated', label: 'WooCommerce Update', icon: Zap, description: 'When a WooCommerce order is updated' },
