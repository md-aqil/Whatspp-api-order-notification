  ...
  },
  {
    ...
    steps: [
      ...
      { 
        ...
        connections: { 
          main: '', 
          fallback: 'step-msg-fallback-1' 
        } 
      },
      { 
        id: 'step-msg-fallback-1', 
        type: 'message', 
        title: 'AI Fallback Reply', 
        channel: 'whatsapp', 
        message: 'I\'m sorry, I\'m thinking a bit slow right now! 🤖✨ A human agent will be with you shortly to help you out. Hang tight!', 
