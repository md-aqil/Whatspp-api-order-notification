export const defaultAutomations = [
  {
    ...
    steps: [
      ...
      { id: 'step-msg-cod-confirmed', type: 'message', title: 'Confirmation Reply', channel: 'whatsapp', template: '', templateLanguage: '', message: '🎉 Fantastic! Your order #{{order_number}} is verified and sent to fulfillment. We will notify you with tracking as soon as it ships! 🚚', position: { x: 1180, y: 160 }, connections: { main: '' } },
      { id: 'step-msg-cod-cancelled', type: 'message', title: 'Cancellation Reply', channel: 'whatsapp', template: '', templateLanguage: '', message: '❌ Your order #{{order_number}} has been cancelled. If you ever change your mind, we are here for you! ✨', position: { x: 1180, y: 360 }, connections: { main: '' } }
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'step-message-3', type: 'message', title: 'Ask for Judge.me Review', channel: 'whatsapp', template: 'hello_world', templateLanguage: 'en_US', message: 'Hi {{customer_name}}, your order #{{order_number}} ({{order_product_name}}) has just been delivered! 📦✨\n\nHow was your experience with us? We\'d love your feedback!\n\n⭐ Leave a quick review on Judge.me: {{review_link}}\n\nThank you for choosing Vaclav! 🙏', position: { x: 560, y: 260 }, connections: { main: '' } }
    ]
  },
  {
    ...
    steps: [
      ...
      { id: 'step-msg-acc', type: 'message', title: 'Accessories', channel: 'whatsapp', template: '', templateLanguage: '', message: 'Browse our premium accessories selection here: https://example.com/accessories', position: { x: 1260, y: 600 }, connections: { main: '' } },
      
      { id: 'step-msg-returns', type: 'message', title: 'Returns Policy', channel: 'whatsapp', template: '', templateLanguage: '', message: 'We offer a hassle-free 30-day return policy on all unworn items with original tags attached! Let us know if you need a return label.', position: { x: 1260, y: 720 }, connections: { main: '' } },
      { id: 'step-msg-shipping', type: 'message', title: 'Shipping info', channel: 'whatsapp', template: '', templateLanguage: '', message: 'Standard shipping takes 3-5 business days. Express shipping is delivered in 1-2 business days!', position: { x: 1260, y: 840 }, connections: { main: '' } },
      { id: 'step-msg-loc', type: 'message', title: 'Store Location', channel: 'whatsapp', template: '', templateLanguage: '', message: 'Our flagship store is located at 123 Fashion Ave. We\'re open Monday-Saturday, 10 AM to 8 PM. Hope to see you there!', position: { x: 1260, y: 960 }, connections: { main: '' } }
    ]
  },
  {
