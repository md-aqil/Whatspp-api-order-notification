export const defaultAutomations = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'step-msg-ord', type: 'message', title: 'Order Status Reply', channel: 'whatsapp', template: '', templateLanguage: '', message: 'I can certainly help with that! 📦\n\n🔍 If you placed an order with this WhatsApp number, we are checking your latest order details right now.\n\nTo check a specific order, please reply with your **Order ID** (e.g. #1042 or 1042), and I\'ll pull up the live tracking information immediately!', position: { x: 860, y: 160 }, connections: { main: '' } },
