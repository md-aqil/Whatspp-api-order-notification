export const defaultAutomations = [
  ...
  },
  {
    ...
    status: false,
    source: 'Instagram',
    summary: 'Auto-reply to public comments matching key search words (e.g. "price", "link") and instantly deliver a private DM with discount links.',
    metrics: { sent: 0, openRate: 0, conversions: 0 },
    steps: [
      ...
      { id: 'step-msg-ig-growth-reply', type: 'message', title: 'Comment Reply & DM Delivery', channel: 'instagram', message: 'Hey @{{username}}! 🌟 I just slid into your DMs with your exclusive 15% discount code **INSTA15** and the private shop link. Check your inbox! 📥✨', position: { x: 820, y: 260 }, connections: { main: '' } }
    ]
  },
  {
    ...
    status: false,
    source: 'Instagram',
    summary: 'A complete inbound DM responder that lets customers select interactive buttons (Support, Coupon, Order Status) and replies automatically.',
    metrics: { sent: 0, openRate: 0, conversions: 0 },
    steps: [
      ...
      { id: 'step-inter-ig-faq', type: 'interactive', title: 'Welcome Assistant', message: 'Hello @{{username}}! 👋 Welcome to our official support assistant. \n\nHow can we serve you today? Tap one of the buttons below to start:', options: [{ id: 'opt-coupon', label: '🎟️ Get Voucher' }, { id: 'opt-status', label: '📦 Order Status' }, { id: 'opt-human', label: '💬 Talk to Agent' }], position: { x: 460, y: 340 }, connections: { 'opt-coupon': 'step-msg-ig-coupon', 'opt-status': 'step-msg-ig-status', 'opt-human': 'step-msg-ig-human' } },
      { id: 'step-msg-ig-coupon', type: 'message', title: 'Voucher Code Reply', channel: 'instagram', message: 'Here is your welcome code: **WELCOME10** for 10% off your next purchase! 🎟️✨\n\nShop now: https://chatflow.vibeship.in', position: { x: 860, y: 160 }, connections: { main: '' } },
      ...
      { id: 'step-msg-ig-human', type: 'message', title: 'Human Handoff', channel: 'instagram', message: 'Connecting you with our support specialists... 💬 \n\nPlease stay online, a human agent will be with you directly in this DM thread shortly!', position: { x: 860, y: 520 }, connections: { main: '' } }
    ]
  },
  {
    ...
    status: false,
    source: 'Instagram',
    summary: 'Detect brand mentions in user stories, trigger a Zoho CRM Lead creation, and reply with a thank-you voucher.',
    metrics: { sent: 0, openRate: 0, conversions: 0 },
    steps: [
      ...
      { id: 'step-msg-ig-mention-thanks', type: 'message', title: 'Send Thank You Coupon', channel: 'instagram', message: 'You are absolutely amazing, @{{username}}! 💖 \n\nThank you so much for the story mention. We love having you in our community! As a token of our appreciation, here is a $5 voucher to use on your next order: **STORY5** 🎁✨', position: { x: 820, y: 260 }, connections: { main: '' } }
    ]
  }
]
