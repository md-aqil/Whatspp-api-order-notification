export const defaultAutomations = [
  ...
  {
    id: 'default-instagram-reply',
    name: 'Instagram DM & Comment Auto-Reply',
    status: false,
    source: 'Instagram',
    summary: 'Instantly reply to customer comments publically and send an automated, rich Direct Message with dynamic values.',
    metrics: { sent: 0, openRate: 0, conversions: 0 },
    steps: [
      { id: 'step-trigger-ig-1', type: 'trigger', title: 'Instagram Comment', event: 'instagram.comment_created', description: 'Triggered when a customer comments on any post', position: { x: 120, y: 260 }, connections: { main: 'step-message-ig-1' } },
      { id: 'step-message-ig-1', type: 'message', title: 'Send Comment Reply & DM', message: 'Hi @{{username}}! Thank you so much for your comment on our recent post. ✨ \n\nI have just sent you a Direct Message with all the exclusive details and links you requested. Check your DMs! 📥', position: { x: 500, y: 260 }, connections: { main: '' } }
    ]
  }
]
