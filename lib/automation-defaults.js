export const defaultAutomations = [
  ...
  },
  {
    ...
    status: false,
    source: 'Zoho',
    summary: 'Create or update a Zoho Lead whenever a WhatsApp conversation receives a new inbound message.',
    metrics: { sent: 0, openRate: 0, conversions: 0 },
    steps: [
      { id: 'step-trigger-whatsapp-zoho-1', type: 'trigger', title: 'WhatsApp message received', event: 'whatsapp.message_received', description: 'A new inbound WhatsApp message is saved in ChatFlow', position: { x: 120, y: 260 }, connections: { main: 'step-zoho-upsert-lead-1' } },
      {
