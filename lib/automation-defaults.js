export const defaultAutomations = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'step-interactive-zoho-1', type: 'interactive', title: 'Lead Options', message: 'Please select an option below to proceed:', options: [{ id: 'opt0', label: '📞 Request Call' }, { id: 'opt1', label: '📄 View Brochure' }, { id: 'opt2', label: '💬 Chat with Us' }], position: { x: 1180, y: 260 }, connections: { opt0: 'step-msg-zoho-call', opt1: 'step-msg-zoho-docs', opt2: 'step-msg-zoho-chat' } },
      { id: 'step-msg-zoho-call', type: 'message', title: 'Call Request', channel: 'whatsapp', message: 'Understood! 📞 One of our account managers will give you a call on {{customer_phone}} shortly. Talk soon!', position: { x: 1540, y: 100 }, connections: { main: '' } },
      { id: 'step-msg-zoho-docs', type: 'message', title: 'Brochure Link', channel: 'whatsapp', message: 'Of course! 📄 You can view our latest service brochure here: https://example.com/brochure. Let us know if you have questions!', position: { x: 1540, y: 260 }, connections: { main: '' } },
      { id: 'step-msg-zoho-chat', type: 'message', title: 'Chat Handoff', channel: 'whatsapp', message: 'Connecting you to our support team... 💬 A specialist will be with you in a moment!', position: { x: 1540, y: 420 }, connections: { main: '' } }
    ]
  },
  {
