...
export async function seedDefaultAutomationsForUser(userId) {
  const defaults = [
    ...
    {
      id: 'default-zoho-lead',
      name: 'Zoho Lead Notification',
      status: true,
      source: 'System',
      summary: 'Sends a message when a new lead is updated in Zoho CRM.',
      steps: [
        {
          id: 'step-trigger-zoho-1',
          type: 'trigger',
          event: 'zoho.lead_updated',
          title: 'Zoho Lead Updated',
          position: { x: 100, y: 100 },
          connections: { main: 'step-message-zoho-1' },
          description: 'Triggers when a lead is created or updated in Zoho CRM'
        },
        {
          id: 'step-message-zoho-1',
          type: 'message',
          title: 'Send Greeting',
          channel: 'whatsapp',
          message: 'Hi {{customer_name}}, thank you for your interest! We have received your update. A member of our team will contact you shortly.',
