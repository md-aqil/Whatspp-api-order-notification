...
const VARIABLE_DEFINITIONS = [
  ...
  { value: '{{order_product_name}}', label: 'Ordered product name', triggers: ['shopify.order_created', 'shopify.fulfillment_created', 'shopify.order_delivered', 'woocommerce.order_created', 'woocommerce.order_updated', 'custom.webhook', 'custom.order_created'] },
  { value: '{{order_product_names}}', label: 'Ordered product names', triggers: ['shopify.order_created', 'shopify.fulfillment_created', 'shopify.order_delivered', 'woocommerce.order_created', 'woocommerce.order_updated', 'custom.webhook', 'custom.order_created'] },
