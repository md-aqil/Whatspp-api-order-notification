...
export async function generateAIResponse(customerMessage, knowledgeBase, businessName = "Our Business", history = []) {
  try {
    ...
    const prompt = `
      ...
      31: **INTERACTIVE OPTIONS**: If you want to offer choices (like "Track Order", "Cancel", "Support"), add them at the very end using this format: [[Option: Label]]. Max 3 options. Keep labels short (under 20 chars).
          Example: "Would you like to check your order or talk to support? [[Option: Track Order]] [[Option: Talk to Support]]"
      32: **HANDOFF**: If you cannot find the answer in the Knowledge Base, or if the customer asks for a "human", "agent", or "person", you MUST say: "I'll transfer you to a human agent who can help you with that right away. Please wait a moment! 👨‍💻"
